...
Papers are ranked by **topical relevance** (an LLM-assigned 0–100 score), with publication date as the tiebreak so the most relevant recent work surfaces first — including preprints. Reviews & surveys are selected by citation count and recency.  
Updated weekly via GitHub Actions · Sources: arXiv · Semantic Scholar · chemRxiv · OpenReview (ICLR/NeurIPS/ICML)

Relevance scoring, classification (article vs. review), on-topic filtering, and venue normalisation are handled by **gpt-4o-mini**: keyword pre-filtering runs first, then the LLM grades relevance, gates quality, and corrects false positives. Please open an issue if you spot a misclassified entry.
...
| [Self-Optimizing GPU Kernels for Computational Chemistry: An Autonomous Accelerat…](https://doi.org/10.26434/chemrxiv.15007561/v1) | 2026-08-18 | chemRxiv | - |
| [An Agentic Artificial-Intelligence Framework for Automated First-Principles X-ra…](https://doi.org/10.26434/chemrxiv.15006672/v1) | 2026-07-28 | chemRxiv | - |
...
| [Smart Exploration of Perovskite Photovoltaics: From AI Driven Discovery to Auton…](https://doi.org/10.1002/aenm.202506803) | 2026-03-27 | Advanced Energy Materi… | - |
...
| [Autonomous De Novo Lead Halide CsPbBr3 Perovskite Quantum Dots Synthesis Platfor…](https://doi.org/10.1002/smll.202504547) | 2025-07-20 | Small | [Code](https://github.com/huanghandage/CsPbBr3) |
...
| [A Scientific Reasoning Model for Organic Synthesis Procedure Generation](https://arxiv.org/abs/2512.13668) | 2025-12-15 | arXiv | [Code](https://github.com/syr-cn/ReactXT/tree/master/openExp) |
| [Accelerating Drug Discovery Through Agentic AI: A Multi-Agent Approach to Labora…](https://arxiv.org/abs/2507.09023) | 2025-07-11 | arXiv | - |
| [Collaborative AI Enhances Image Understanding in Materials Science](https://arxiv.org/abs/2503.13169) | 2025-03-17 | AI for Materials | - |
| [Smart Dope: A Self‐Driving Fluidic Lab for Accelerated Development of Doped Pero…](https://onlinelibrary.wiley.com/doi/pdfdirect/10.1002/aenm.202302303) | 2023-11-12 | Advanced Energy Materi… | [Code](https://github.com/AbolhasaniLab/Smart-Dope) |
| [GPT-Lab: Next Generation Of Optimal Chemistry Discovery By GPT Driven Robotic La…](https://arxiv.org/pdf/2309.16721) | 2023-09-15 | arXiv | - |
| [Autonomous discovery of optically active chiral inorganic perovskite nanocrystal…](https://www.nature.com/articles/s41467-020-15728-5.pdf) | 2020-04-27 | Nat. Commun. | - |
